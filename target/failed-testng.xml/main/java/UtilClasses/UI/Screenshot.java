...
public class Screenshot extends TestListenerAdapter {
    ...
    public void attacheScreenshotToTestReport(ITestResult result){
			...
			String imagePathInHost = "./Screenshots" + Seperator + "screenshots"
	...
	public String captureScreenshot(WebDriver driver, String sTestClassName, String sFileName) {
		...
		try {
			File file = new File("./Screenshots" + Seperator + "screenshots"+ Seperator + resultSetName);
			if (!file.exists()) {
			...
			File targetFile = new File("./Screenshots" + Seperator + "screenshots"
