...
public class ExtentManager {
    ...
    String reportPath = "C:" + Seperator + "Apache24" + Seperator + "htdocs" + Seperator + "AutomationReports"  + Seperator + "BackBaseBlog_" + ScriptExecutionDate + ".html";
    ...
    public static ExtentReports createInstance(String reportPath) {
        ...
        htmlReporter.config().setDocumentTitle("BackBaseBlog Sanity Tests");
        htmlReporter.config().setReportName("BackBaseBlog Sanity Tests");
